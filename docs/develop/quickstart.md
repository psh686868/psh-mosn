...
MOSN 项目的代码托管在 [github](https://github.com/psh686868/psh-mosn)，获取方式如下：

```bash
go get github.com/psh686868/psh-mosn
```
...
使用您喜爱的Golang IDE导入 `$GOPATH/src/github.com/psh686868/psh-mosn` 项目，推荐Goland。
